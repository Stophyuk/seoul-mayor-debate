      ...
      <div className="max-w-4xl mx-auto px-6 pt-12 pb-8">
        <div className="text-center space-y-3 mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-black tracking-tight">
            <span className="text-emerald-400">홍봇</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
          {/* Hongbot profile */}
          <div className="relative overflow-hidden rounded-2xl bg-navy-900 border border-navy-700 shadow-lg">
            <div className="h-2 bg-gradient-to-r from-emerald-400 to-teal-500" />
            <div className="p-6 text-center">
              {/* Avatar silhouette */}
              <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-gradient-to-br from-emerald-900 via-emerald-800 to-teal-900 flex items-center justify-center">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-emerald-700 via-teal-600 to-emerald-500 flex items-center justify-center">
              ...
              <p className="text-sm text-emerald-400/70 font-medium mt-1">
                {HONGBOT_INFO.title}
              </p>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-navy-900 border border-navy-700 shadow-lg">
            ...
            <div className="p-6 text-center">
              {/* Avatar silhouette */}
              <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-gradient-to-br from-amber-900 via-amber-800 to-yellow-900 flex items-center justify-center">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-amber-700 via-yellow-600 to-amber-500 flex items-center justify-center">
              ...
              <p className="text-sm text-amber-400/70 font-medium mt-1">
                {HONGGEUN_INFO.title}
              </p>
              <p className="text-xs text-slate-500 mt-2">
                59세 | 4선 의원 20년 경력
        ...
        {/* Comparison table */}
        <div className="bg-navy-900 rounded-2xl border border-navy-700 shadow-lg overflow-hidden mb-10">
          <div className="px-6 py-4 bg-navy-800 border-b border-navy-700">
            <h3 className="text-center font-bold text-slate-300">
              프로필 비교
            </h3>
          </div>
          <div className="divide-y divide-navy-700">
            {comparisonItems.map((item) => (
              ...
              >
                <div className="text-base text-emerald-400 font-medium text-right pr-4">
                  {item.bot}
                </div>
                <div className="text-sm text-slate-500 font-bold text-center uppercase tracking-wider">
                  {item.label}
                </div>
                <div className="text-base text-amber-400 font-medium text-left pl-4">
                  {item.human}
                </div>
              </div>
            ))}
